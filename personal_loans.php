        ...
        <div class="index-page-content minw-500">
            ...
            <div class="container-fluid info-main-content">
                <div class="jumbotron jumbotitle jumbotron-fluid mt-5">
                    <div class="container">
                        <h1 class="display-4">Get a loan from us</h1>
                        <p class="lead">Free yourself to pursue your dreams</p>
                    </div>
                </div>
                <div class="jumbotron jumbotron-fluid mt-5">
                    <div class="container">
                        <div class="row">
                            ...
                            <p class="lead col">We have the fairest rates on the island!</p>
                        </div>
                    </div>
                </div>
                <div class="jumbotron jumbotron-fluid mt-5">
                    <div class="container">
                        <div class="row">
                            <p class="lead col">Up to 25 years to repay the loan, we allow you to focus on things that matter the most</p>
                            <h1 class="display-4 col-md-5">Embrace Flexibility</h1>
                        </div>
                    </div>
                </div>
                <div class="jumbotron jumbotron-fluid mt-5">
                    <div class="container">
                        <h1 class="display-4">Find out more from us!</h1>
                        <p class="lead col">Contact us to find out more about applying for a loan</a></p>
                    </div>
                </div>
            </div>
        </div>
